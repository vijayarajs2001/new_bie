...
// -----------------------------------------------------------------------------------------------------------------------------------
function releaseCountInYear(year) {
...
function highestUpdatesByAuthor() {
    ...
    console.table(`"The author named (${authorName}) released more number of version and the count is ${counter}"`)
}
// -----------------------------------------------------------------------------------------------------------------------------------
function typesOfUpdateSearch(str) {
    let typeVariable = androidVersion.filter(n => n.type.includes(str))
    console.table(`Total versions having ${str} type releases : ${typeVariable.length} `)
    console.table(typeVariable)
}
// -----------------------------------------------------------------------------------------------------------------------------------
function featuresKeyWordSearch(str) {
